      ...
      <div className="info__container">
        <div className="info__me">
          <div className="info__more">
            ...
            <span>
              My principle : Find your own activities without disturbing other
              people's activities, other people don't need us, only we ourselves
              feel needed, we do 100 good things, people will forget it all if
              we make 1 mistake. "NOTE : STOP BEING A GOOD PERSON"
            </span>
          </div>
        ...
        <div className="info__achieve">
          <div className="info__item">
            ...
            <div className="info__detail">
              ...
              >
                Computer science faculty <i class="uil uil-arrow-up-right"></i>
              </a>
            </div>
          </div>
          <div className="info__item">
